...
document.addEventListener('DOMContentLoaded', function () {
    ...
    telegramDiv.addEventListener('click', function () {
        window.open('https://t.me/MinhTran_info', '_blank');
    });
});
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    telegramDiv.addEventListener('click', function () {
        window.open('https://github.com/minhtn09', '_blank');
    });
});
document.addEventListener('DOMContentLoaded', function () {
    var telegramDiv = document.querySelector('.Facebook');
    telegramDiv.addEventListener('click', function () {
        window.open('https://facebook.com/minhtrancutis1', '_blank');
    });
});
document.addEventListener('DOMContentLoaded', function () {
    var telegramDiv = document.querySelector('.Instagram');
    telegramDiv.addEventListener('click', function () {
        window.open('https://www.instagram.com/minhcon0563/', '_blank');
    });
});
document.addEventListener('DOMContentLoaded', function () {
    var telegramDiv = document.querySelector('.Tiktok');
    telegramDiv.addEventListener('click', function () {
        window.open('https://tiktok.com/@chubedan956', '_blank');
    });
});
document.addEventListener('DOMContentLoaded', function () {
    var telegramDiv = document.querySelector('.Zalo');
    telegramDiv.addEventListener('click', function () {
        window.open('https://zalo.me/0922149006', '_blank');
    });
});

// Thay Ä‘á»•i ná»™i dung cá»§a pháº§n tá»­ cĂ³ id "checkip_address" báº±ng thĂ´ng tin Ä‘Ă£ cho
function updateInfo(info) {
    const element = document.getElementById("checkip_address");
    element.textContent = info;
}

// Hiá»ƒn thá»‹ thĂ´ng tin IP vĂ  Ä‘á»‹a chá»‰ vá»‹ trĂ­
function displayInfo() {
    fetch('https://api.ipify.org?format=json')
        .then(response => response.json())
        .then(data => {
            const ipAddress = data.ip;
            updateInfo(ipAddress); // Hiá»ƒn thá»‹ Ä‘á»‹a chá»‰ IP

            setTimeout(() => {
                // Láº¥y thĂ´ng tin vá»‹ trĂ­ tá»« API cung cáº¥p Ä‘á»‹a chá»‰ IP
                fetch(`https://ipapi.co/${ipAddress}/json/`)
                    ...
                    .then(data => {
                        ...
                        updateInfo(locationInfo); // Hiá»ƒn thá»‹ Ä‘á»‹a chá»‰ vá»‹ trĂ­

                        setTimeout(displayInfo, 1500); // Gá»i láº¡i hĂ m displayInfo sau 2 giĂ¢y
                    })
                    .catch(error => {
                        console.error('Lá»—i khi láº¥y thĂ´ng tin vá»‹ trĂ­:', error);
                        updateInfo("KhĂ´ng thá»ƒ láº¥y thĂ´ng tin vá»‹ trĂ­");
                    });
            }, 2000); // Chá» 2 giĂ¢y trÆ°á»›c khi láº¥y thĂ´ng tin vá»‹ trĂ­
        })
        .catch(error => {
            console.error('Lá»—i khi kiá»ƒm tra Ä‘á»‹a chá»‰ IP:', error);
            updateInfo("KhĂ´ng thá»ƒ láº¥y Ä‘á»‹a chá»‰ IP");
        });
}

// Gá»i hĂ m hiá»ƒn thá»‹ thĂ´ng tin IP vĂ  Ä‘á»‹a chá»‰ vá»‹ trĂ­
displayInfo();



console.log('%c* đ‘ºđ‘»đ‘¶đ‘· đ‘ªđ‘¶đ‘·đ’€ đ‘ºđ‘¶đ‘¼đ‘¹đ‘ªđ‘¬ !', 'color: red; font-size: 50px; font-family: sans-serif; text-shadow: 1px 1px 5px #000;');
console.log('%c- CĂ³ váº» nhÆ° báº¡n Ä‘ang cá»‘ tĂ¬nh Äƒn cáº¯p mĂ£ nguá»“n cá»§a tĂ´i Minh Tráº§n >.', 'color: #444; font-size: 25px; font-family: sans-serif;');
console.log('%c- ÄĂ³ lĂ  hĂ nh vi khĂ´ng tá»‘t, cáº§n source inbox facebook Ä‘á»ƒ xin.\n', 'color: #444; font-size: 25px; font-family: sans-serif;');
...
// Láº¥y pháº§n tá»­ overlay
var overlay = document.getElementById("overlay");

// Táº¡o pháº§n tá»­ div cho pháº§n text
var textDiv = document.createElement("div");
textDiv.id = "text";

// Táº¡o pháº§n tá»­ p cho dĂ²ng chá»¯ "Welcome to my website"
var welcomeText = document.createElement("p");
welcomeText.style.fontFamily = "Quicksand";
welcomeText.style.fontSize = "20px";
welcomeText.textContent = "đ‘«đ’†đ’”đ’đ’ˆđ’đ’†đ’… đ’ƒđ’ đ‘»đ‘«đ‘´ =))";
welcomeText.style.marginBottom = "10px"; // Khoáº£ng cĂ¡ch dÆ°á»›i 10px


// Táº¡o pháº§n tá»­ p cho dĂ²ng chá»¯ "- Nháº¥n Ä‘á»ƒ tiáº¿p tá»¥c -"
...
// ThĂªm cĂ¡c pháº§n tá»­ vĂ o pháº§n tá»­ textDiv
textDiv.appendChild(welcomeText);
textDiv.appendChild(continueText);

// ThĂªm pháº§n tá»­ textDiv vĂ o overlay
overlay.appendChild(textDiv);

// Thiáº¿t láº­p sá»± kiá»‡n click cho overlay
overlay.addEventListener("click", function () {
    // áº¨n overlay
    overlay.style.display = "none";

    // ThĂªm mĂ£ JavaScript cá»§a báº¡n Ä‘á»ƒ báº¯t Ä‘áº§u phĂ¡t nháº¡c hoáº·c thá»±c hiá»‡n cĂ¡c hĂ nh Ä‘á»™ng khĂ¡c á»Ÿ Ä‘Ă¢y
});
