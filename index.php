                ...
                <div class="col-12">
                    <div class="row row-col-10">
                            ...
                            <div class="service-card">
                                ...
                                <div class="service-content">
                                    <a href="https://TRUMTHE.VN" class="service-content_title">
                                        TRUMTHE.VN
                                    </a>
                                    <div class="service-content_desc">
                                ...
                                <div class="service-action">
                                    <a href="https://TRUMTHE.VN" class="btn-theme btn-theme_white">
                                        Truy Cập
                                        <span></span>
                                    </a>
                                </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="row row-col-10">
                                                        <div class="col-12 col-sm-6 col-lg-3">
                                <a href="https://TRUMTHE.VN" class="article-card card">
